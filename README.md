...
* [jadx - Dex to Java decompiler](https://github.com/skylot/jadx/releases) ⭐ 50,392 | 🐛 446 | 🌐 Java | 📅 2026-09-08
* [Infer – A Static Analysis tool for Java, C, C++ and Objective-C](https://github.com/facebook/infer) ⭐ 15,705 | 🐛 208 | 🌐 OCaml | 📅 2026-09-09
* [Checkstyle – A tool for checking Java source code](https://github.com/checkstyle/checkstyle) ⭐ 9,568 | 🐛 760 | 🌐 Java | 📅 2026-09-09
...
* [PMD – An extensible multilanguage static code analyzer](https://github.com/pmd/pmd) ⭐ 5,486 | 🐛 586 | 🌐 Java | 📅 2026-09-09
...
* [mariana-trench - Our security focused static analysis tool for Android and Java applications.](https://github.com/facebook/mariana-trench) ⭐ 1,256 | 🐛 46 | 🌐 C++ | 📅 2026-09-09
...
* [Magisk v23.0 - Root & Universal Systemless Interface](https://github.com/topjohnwu/Magisk) ⭐ 62,661 | 🐛 35 | 🌐 Kotlin | 📅 2026-09-05
* [Radare2 - Unix-like reverse engineering framework and commandline tools](https://github.com/radareorg/radare2) ⭐ 24,771 | 🐛 822 | 🌐 C | 📅 2026-09-09
* [Mobile-Security-Framework MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,731 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09
* [Objection - Runtime Mobile Exploration toolkit, powered by Frida](https://github.com/sensepost/objection) ⭐ 9,374 | 🐛 57 | 🌐 Python | 📅 2026-07-23
...
* [FlutterTap - Zygisk module that bypasses BoringSSL TLS pinning inside libflutter.so and redirects Flutter app traffic to a proxy, persistently and without a Frida session](https://github.com/script-or-script/FlutterTap) ⭐ 113 | 🐛 0 | 🌐 C++ | 📅 2026-08-07
...
* [OWASP-mstg(UnCrackable Mobile Apps)](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,170 | 🐛 238 | 🌐 Python | 📅 2026-09-09
...
* [PhoneSploit with Metasploit Integration](https://github.com/AzeemIdrisi/PhoneSploit-Pro) ⭐ 6,240 | 🐛 1 | 🌐 Python | 📅 2026-09-06
* [apk-mitm - a CLI application that prepares Android APK files for HTTPS inspection](https://github.com/shroudedcode/apk-mitm) ⭐ 5,105 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24
...
* [Shodan.io-mobile-app for Android](https://github.com/PaulSec/Shodan.io-mobile-app) ⭐ 225 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-05
...
* [OWASP Mobile Security Testing Guide (MSTG)](https://github.com/OWASP/owasp-mstg/tree/master/Checklists) ⭐ 13,170 | 🐛 238 | 🌐 Python | 📅 2026-09-09
